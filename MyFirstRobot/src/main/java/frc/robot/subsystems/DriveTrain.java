...
public class DriveTrain extends Subsystem {
  ...
  // PRIVATE Because somewhere else in the code may damage the motors.
  ...
  //public, void = don't care about retunring anything; 
  public void setLeftMotors(double speed){
    motorLeft1.set(ControlMode.PercentOutput, -speed);
    motorLeft2.set(ControlMode.PercentOutput, -speed);
  }
  //setR/L Motors taking double value and giving that info to the Motor Controllers.
